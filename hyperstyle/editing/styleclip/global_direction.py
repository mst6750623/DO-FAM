...
from .stylespace_utils import features_channels_to_s
    ...
    def _get_averaged_text_features(self, text_prompts):
        with torch.no_grad():
            ...
            for text_prompt in text_prompts:
                ...
                formatted_text_prompts = clip.tokenize(
                    formatted_text_prompts).cuda()  # tokenize
                text_embeddings = self.clip_model.encode_text(
                    formatted_text_prompts)  # embed with text encoder
